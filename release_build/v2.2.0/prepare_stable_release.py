...
def main() -> int:
    ...
    manifest = {
        ...
        'changelog': '2.2.0：修复整合包重新解压后的真实首次启动状态；新增 PGPatcher / TruePBR 适配，可自动发现 PGPatcher、通过当前 MO2 VFS 启动、检查并安全禁用旧 PGPatcher 输出、阻止 DynDOLOD 输出状态冲突，并补充正确的 PBR 生成顺序与内置教程。',
        'package': {
